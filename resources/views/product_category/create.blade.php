        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form class="w-full max-w-xl" method="POST" action="{{ route('product-category.store') }}">
                        @csrf
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-2/3">
                              ...
                              id="product-category-description" name="description" placeholder="More information"></textarea>
                            </div>
                          </div>
